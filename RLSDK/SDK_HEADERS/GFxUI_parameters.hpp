...
struct UGFxMoviePlayer_execSetWidgetPathBinding_Params
{
	...
	class FName                                        Path;                                             // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
struct UGFxMoviePlayer_execCreateObject_Params
{
	...
	class TArray<struct FASValue>                      args;                                             // 0x0018 (0x0010) [0x0000000000400090] (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
...
struct UGFxObject_execSetFunction_Params
{
	...
	class FName                                        fname;                                            // 0x0018 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
