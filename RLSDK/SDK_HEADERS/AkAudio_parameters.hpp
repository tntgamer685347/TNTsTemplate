...
{
	class FName                                        BusName;                                          // 0x0000 (0x0008) [0x0000000000000080] (CPF_Parm)    
...
{
	class FName                                        BusName;                                          // 0x0000 (0x0008) [0x0000000000000080] (CPF_Parm)    
	class FName                                        EffectSetting;                                    // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
...
{
	class FName                                        InStateGroup;                                     // 0x0000 (0x0008) [0x0000000000000080] (CPF_Parm)    
	class FName                                        InState;                                          // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
struct UAkDevice_execSetSwitch_Params
{
	...
	class FName                                        Value;                                            // 0x0010 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
struct UAkParamGroup_execPrintDebugInfo_Params
{
	...
	// class TArray<class FName>                       RTCPKeys;                                         // 0x0008 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	// class TArray<float>                             RTCPValues;                                       // 0x0018 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	// class TArray<class FName>                       SwitchKeys;                                       // 0x0028 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	// class TArray<class FName>                       SwitchValues;                                     // 0x0038 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
	class FName                                        Key;                                              // 0x0000 (0x0008) [0x0000000000000080] (CPF_Parm)    
	class FName                                        Value;                                            // 0x0008 (0x0008) [0x0000000000000080] (CPF_Parm)    
};
...
{
	class TArray<class FName>                          RTCPKeys;                                         // 0x0000 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	class TArray<float>                                RTCPValues;                                       // 0x0010 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	class TArray<class FName>                          SwitchKeys;                                       // 0x0020 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
	class TArray<class FName>                          SwitchValues;                                     // 0x0030 (0x0010) [0x0000000000400180] (CPF_Parm | CPF_OutParm | CPF_NeedCtorLink)
};
